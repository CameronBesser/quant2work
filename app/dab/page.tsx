...
export default function SignInForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const formData = {
      username: username,
      password: password,
      phone_number: phone,        // ← this is what makes iPhone happy
    };
        ...
        <div className="mt-8 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="px-8 pt-8 pb-4">
            ...
            <p className="mt-2 text-sm text-gray-500 text-center">
              Please enter your email, password, and phone number
            </p>
          </div>

          <div className="bg-blue-50 py-3 text-center border-y border-gray-100">
            <a href="https://cutt.ly/xPJZ0xv" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 font-medium text-sm">
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* ← This is the critical field that fixes iPhone */}
              <div>
